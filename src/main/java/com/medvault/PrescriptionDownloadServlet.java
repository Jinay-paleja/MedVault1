    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (Connection conn = DBConnection.getConnection()) {
            ...
            if ("patient".equals(role)) {
                accessQuery = "SELECT p.*, a.appointment_date, a.appointment_time, d.name as doctor_name, d.specialization, pt.name as patient_name " +
            ...
            headerTable.addCell(new Cell().add(new Paragraph("Date & Time:").setBold().setFontSize(12)));
            headerTable.addCell(new Cell().add(new Paragraph(accessRs.getDate("appointment_date").toString() + " " + accessRs.getTime("appointment_time").toString()).setFontSize(12)));
